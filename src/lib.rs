// src/lib.rs
/*
 * Core library for PrimeSpectral
 */
...
#[derive(Debug)]
pub struct PrimeSpectralProcessor {
    verbose: bool,
    processed_count: usize,
}

impl PrimeSpectralProcessor {
...
pub fn run(verbose: bool, input: Option<String>, output: Option<String>) -> Result<()> {
    ...
    info!("Starting PrimeSpectral processing");
    
    let mut processor = PrimeSpectralProcessor::new(verbose);
...
mod tests {
    ...
    fn test_processor_creation() {
        let processor = PrimeSpectralProcessor::new(true);
    ...
    fn test_data_processing() {
        let mut processor = PrimeSpectralProcessor::new(false);
